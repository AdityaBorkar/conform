...
**StrictRuleOverrides**:
 Typed RuleOverrides where known IDs (`husky/hook`, `package-json/required-fields`, `gitignore/excludes`) enforce their param type via RuleRegistry (params flattened, `level` optional); other IDs accept any RuleConfig.
